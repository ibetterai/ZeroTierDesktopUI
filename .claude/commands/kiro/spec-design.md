...
- **MANDATORY**: Document ALL research in `.kiro/knowledge/architecture-{pattern}-{number}.md`
- **MANDATORY**: Create comparison documents in `.kiro/knowledge/comparison-{technologies}-{number}.md`
...
- **MANDATORY**: Document ALL findings in `.kiro/knowledge/research-{dependency}-{number}.md`
- **MANDATORY**: Create `.kiro/knowledge/docs-{dependency}-{number}.md` for fetched documentation
